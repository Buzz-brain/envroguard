...
export const typography = {
  h1: { fontFamily: poppins[700], fontSize: 32, fontWeight: '700' as const, lineHeight: 40, letterSpacing: -0.5 },
  h2: { fontFamily: poppins[700], fontSize: 24, fontWeight: '700' as const, lineHeight: 32, letterSpacing: -0.3 },
  h3: { fontFamily: poppins[600], fontSize: 20, fontWeight: '600' as const, lineHeight: 28 },
  h4: { fontFamily: poppins[600], fontSize: 18, fontWeight: '600' as const, lineHeight: 24 },
  body: { fontFamily: poppins[400], fontSize: 16, fontWeight: '400' as const, lineHeight: 24 },
  bodySmall: { fontFamily: poppins[400], fontSize: 14, fontWeight: '400' as const, lineHeight: 20 },
  caption: { fontFamily: poppins[400], fontSize: 12, fontWeight: '400' as const, lineHeight: 16 },
  button: { fontFamily: poppins[600], fontSize: 16, fontWeight: '600' as const, lineHeight: 24 },
  label: { fontFamily: poppins[500], fontSize: 14, fontWeight: '500' as const, lineHeight: 20 },
};
